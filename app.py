...
host = os.environ.get('MONGODB_URI', 'mongodb://root:password@srv-captain--mongo:27017/amphibia')
client = MongoClient(host=f'{host}?retryWrites=false&authSource=admin', connect=False)
